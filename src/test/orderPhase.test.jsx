...
test.only("order phases for happy path", async () => {
  ...
  const labelGrandTotalAgain = screen.getByRole("heading", {
    name: /grand total: \$/i,
  });
  ...
  // const inputScoopA = await screen.findByRole("spinbutton", {
  //   name: "Vanilla",
  // });
  // const cbToppingA = await screen.findByRole("checkbox", { name: "Cherries" });
});
